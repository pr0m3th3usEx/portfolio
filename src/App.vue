...
<template>
  <head>
    <title>Thomas Michel - Software Engineer</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="Software Developer crafting impactful digital experiences with expertise in front-end and back-end technologies." />
